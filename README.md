...
- [Mobile Application](https://github.com/efarish/portfolio/tree/main/mobile): Mobile phone apps demonstrating using Python and AWS cloud services.
- [AWS Projects](https://github.com/efarish/portfolio/tree/main/aws): Projects using AWS services like CloudFormation, ECS, SageMaker, Lambda, API Gateway, and CodePipeline.
